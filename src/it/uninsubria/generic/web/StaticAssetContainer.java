...
public class StaticAssetContainer implements Container {
	...
	public void handle(Request request, Response response) {
		...
		if( (request.getPath().toString().contains("/users/")) && (!request.getPath().toString().contains("nourl")) )
			toHandle = new File(ASSETS_DIRECTORY, "user.html");
		else if(request.getPath().toString().equals("/"))
			toHandle = new File(ASSETS_DIRECTORY, "index.html");
		else
			toHandle = new File(ASSETS_DIRECTORY, request.getPath().toString());
